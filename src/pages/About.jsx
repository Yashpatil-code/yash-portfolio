...
const About = () => {
  ...
  const journey = [
    ...
    },
    {
      ...
      description:
        "Started with HTML, CSS, JavaScript, then mastered React.js, Node.js, Express, and MongoDB for full-stack development.",
    },
    {
  ...
  const skills = [
    ...
    {
      category: "Backend",
      items: ["Node.js", "Angular.js", "MongoDB"],
    },
    {
      category: "Tools & Platforms",
      items: ["Git", "PowerBI", "VSCode", "Vercel"],
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className={`text-lg md:text-xl max-w-2xl mx-auto ${textPrimary}`}>
            Data Analyst with hands-on experience in data analytics, business intelligence, and reporting automation. Proficient in
Python, SQL, Power BI, and Advanced Excel for data cleaning, ETL, dashboarding, and insight generation. Experienced in building
interactive BI dashboards, automated reporting systems, and SQL-driven data pipelines that improve decision-making speed and
operational efficiency. Strong collaborator with stakeholders and cross-functional teams.
          </p>
        </div>
