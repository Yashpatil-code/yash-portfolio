  ...
  const contacts = [
    {
      ...
      label: "Email",
      value: "yashspatil2304@gmail.com",
    },
    {
      icon: <Mail className="w-5 h-5" />,
      label: "Alternate Email",
      value: "yp6783443@gmail.com",
    },
    {
  ...
  const socials = [
    {
      ...
      label: "GitHub",
      link: "https://github.com/yash-analytics19",
    },
    {
      icon: <Linkedin className="w-5 h-5" />,
      label: "LinkedIn",
      link: "https://www.linkedin.com/in/yash-patil-255571288",
    },
    {
      icon: <Instagram className="w-5 h-5" />,
      label: "Instagram",
      link: "https://www.instagram.com/itz.yashpatil",
    },
    {
      icon: <MessageCircle className="w-5 h-5" />,
      label: "WhatsApp",
      link: "https://wa.me/7499721932",
    },
