...
const Home = () => {
  ...
  const roles = [
    { icon: FaLaptopCode, title: "Data Analyst", desc: "Crafting responsive and interactive UIs" },
    { icon: FaReact, title: "Web Developer", desc: "Building modern and dynamic web apps" },
    { icon: FaPalette, title: ".NET Developer", desc: "Designing clean and user-friendly interfaces" },
    { icon: FaBug, title: "Social Media Management", desc: "Performing functional and UI testing to ensure quality" },
  ];
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-start pt-14">
          ...
          <div className="flex flex-col justify-center text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              ...
              <a
                href="https://drive.google.com/file/d/1gjo8G9LbL_-4o80AvamKaO2O1UpkAWXG/view?usp=drivesdk"
                target="_blank"
